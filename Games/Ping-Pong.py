...
while True:
    ...
    if score_blue_player == 5:
        ...
        blue_win.write(
            f"Blue player win!!!", align="center", font=("Verdana", 22, "normal")
        )
        score.write(
            f"Blue score: {score_blue_player}\nRed score: {score_red_player}",
            align="center",
        ...
        red_player.goto(1000, 1000)
        red_win.write(
            "Red player win!!!", align="center", font=("Verdana", 22, "normal")
        )
        score.write(
            f"Blue score: {score_blue_player}\nRed score: {score_red_player}",
            align="center",
        ...
        if ball.xcor() > 390:
            ...
            pen.clear()
            pen.write(
                f"Blue player: {score_blue_player}\nRed player {score_red_player}",
                align="center",
                font=("Verdana", 22, "normal"),
            )
        ...
        if (
            ball.xcor() > 340
            and red_player.ycor() + 50 > ball.ycor() > red_player.ycor() - 50
        ):
            ball.dx *= -1

        if (
            ball.xcor() < -340
            and blue_player.ycor() + 50 > ball.ycor() > blue_player.ycor() - 50
        ):
            ball.dx *= -1
